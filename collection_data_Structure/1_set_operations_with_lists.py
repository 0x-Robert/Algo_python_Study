def remove_dup(l1):
    ...
    print("remove_dup l1",list(set(l1)))
    return list(set(l1))

def intersection(l1, l2):
    '''교집합 결과를 반환한다.'''
    print("intersection l1",list(set(l1) & set(l2)))
    return list(set(l1) & set(l2))

def union(l1, l2):
    '''합집합 결과를 반환한다.'''
    print("union set(l1), set(l2)",list(set(l1) |  set(l2) ))
    return list(set(l1) |  set(l2) )

def test_sets_operation_with_lists():
...
if __name__ == '__main__':
   test_sets_operation_with_lists()
